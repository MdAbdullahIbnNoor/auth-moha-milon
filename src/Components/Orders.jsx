                                ...
                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                                        <tr className="bg-white dark:bg-gray-900">
                                            ...
                                            <td className="px-12 py-2 text-sm text-gray-900 dark:text-white">
                                                <span>$250,000</span>
                                            </td>
                                            <td className="px-6 py-2 text-sm text-green-500 dark:text-green-300">
                                                <span>Active</span>
                                            </td>
                                        ...
                                        <tr className="bg-white dark:bg-gray-900">
                                            ...
                                            <td className="px-6 py-2 text-sm text-red-500 dark:text-red-300">
                                                <span>Inactive</span>
                                            </td>
                                            <td className="px-6 py-2 text-sm text-gray-900 dark:text-white">
                                                <button className="text-blue-600 hover:underline focus:outline-none">Edit</button>
